...
export function buildPasswordResetTemplate(p: PasswordResetTemplateParams): {
  ...
  const html = `
    ...
    <body style="margin:0;padding:0;background:#faf8f5;font-family:Georgia,serif;">
      <div style="max-width:480px;margin:40px auto;background:#fff;border:1px solid #e8e0d0;border-radius:8px;padding:40px;">
        ...
        <p style="color:#5c4a3a;margin:0 0 32px;">Ingresa el siguiente codigo para restablecer tu contraseña:</p>
        ...
        <p style="color:#8c7a6a;font-size:13px;line-height:1.5;margin:0;">
          ...
          Si no solicitaste restablecer tu contraseña en PlotCraft, puedes ignorar este correo.
        </p>
      </div>
    </body>
    </html>
  ...
  const text = [
    'PlotCraft — Restablecer tu contraseña',
    '',
    `Hola, ${p.username}.`,
    `Tu codigo de recuperacion es: ${formatted}`,
